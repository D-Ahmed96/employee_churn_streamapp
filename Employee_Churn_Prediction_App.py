...
my_feature_dict_1 = load('my_feature_dict_1.pkl')
...
categorical_input = my_feature_dict_1.get('CATEGORICAL')
...
#numerical_input = my_feature_dict_1.get('NUMERICAL')
...
st.subheader("Created By Danish Ahmed")